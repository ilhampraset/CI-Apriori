...
<html lang="en">
	<head>
		...
		<title></title>
		<link href="<?php echo base_url('assets/img/favicon.png')?>' type='image/x-icon" rel='shortcut icon'>
		...
		<link href="<?php echo base_url('assets/css/bootstrap/font-awesome.min.css')?>" rel="stylesheet">
